...
class GoogleMapSession:
    ...
    def session_id(self) -> None:
        ...
        try:
            ...
            data = {"mapType": "satellite", "language": "en-US", "region": "US"}
    ...
    def download_tile(self, file_path: str = None) -> None:
        ...
        try:
            params = {"session": self.id, "key": self.api_key}
...
if __name__ == "__main__":
    ...
    maps_2d = GoogleMapSession(
        log=logging, api_key=os.environ.get("GOOGLE_MAPS_API"), latLng=latLng, zoom=zoom
    )
    maps_2d.session_id()
